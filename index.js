...
$(document).ready(function () {
  var quotes = [
  "And this is the snack holder where I can put my beverage, or, if you will, cupcake.~Homer Simpson",
  ...
  "Okay, now, the symptoms you describe point to \’bonus eruptus\’, it\’s a terrible disorder where the skeleton tries to leap out the mouth and escape the body!~Dr. Nick Riviera",
  ...
  "Um, can you repeat the part of the stuff where you said all about the things?~Homer Simpson",
